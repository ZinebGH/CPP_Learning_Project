...

{
    ...
    create_keystrokes();
    // On ajoute le manager à la move_queue.
...
// On doit supprimer le const sur create_keystrokes.
void TowerSimulation::create_keystrokes()
{
    ...
    for (int i = 0; i < 8; i++)
    {
        GL::keystrokes.emplace(i + '0', [this, i]() { manager.aircraft_by_index(factory.airline(i)); });
    }
}
